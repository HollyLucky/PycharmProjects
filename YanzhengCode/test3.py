...
BATCH_SIZE=25
#计算一共多少个批次
ls = os.listdir('C:/Users/931/PycharmProjects/YanzhengCode/captcha/images')
count = 0
for i in ls:
    if os.path.isfile(os.path.join('C:/Users/931/PycharmProjects/YanzhengCode/captcha/images',i)):
        count += 1
...
with tf.Session() as sess:
    # inputs: a tensor of size [batch_size, height, width, channels]0
